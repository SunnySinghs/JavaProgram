...
public class ClientTest {
	...
	public static void main(String[] args) {
		...
		Employee e2 = new Employee("emanual", 21000.00, 11, "e@e.com");
		Employee e3 = new Employee("raja", 30000.00, 21, "r@r.com");
		Employee e4 = new Employee("karen", 15000.00, 21, "k@k.com");
		Employee e5 = new Employee("dough", 9000.00, 21, "d@d.com");
		
		Department d1 = new Department(71, "CSE", "Punjab");
		Department d2 = new Department(51, "ECE", "Delhi");
		
		TreeMap<Employee,Department> treeMap = new TreeMap<>(new CustomComparator());
		treeMap.put(e1, d1);
		treeMap.put(e2, d1);
		treeMap.put(e3, d1);
